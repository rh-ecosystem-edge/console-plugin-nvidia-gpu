...
| NVIDIA GPU plugin      | OpenShift Console |
| ---------------------- | ----------------- |
| release-0.3.0          | 4.19+             |
...
- [Red Hat OpenShift](https://www.redhat.com/en/technologies/cloud-computing/openshift) 4.19+ for plugin 0.3.0, or 4.12–4.18 for plugin 0.2.6
